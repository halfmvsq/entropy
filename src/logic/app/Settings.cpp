...
GraphNeighborhoodType AppSettings::graphCutsNeighborhood() const { return m_graphCutsNeighborhood; }
void AppSettings::setGraphCutsNeighborhood( const GraphNeighborhoodType& hood ) { m_graphCutsNeighborhood = hood; }
