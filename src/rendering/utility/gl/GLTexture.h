...
public:
    ...
    getSizedInternalNormalizedRedFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalNormalizedRGFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalNormalizedRGBFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalNormalizedRGBAFormat( const ComponentType& componentType );


    // Sized internal non-normalized formats:

    static tex::SizedInternalFormat
    getSizedInternalRedFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalRGFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalRGBFormat( const ComponentType& componentType );

    static tex::SizedInternalFormat
    getSizedInternalRGBAFormat( const ComponentType& componentType );


    // Normalized buffer pixel formats:

    static tex::BufferPixelFormat
    getBufferPixelNormalizedRedFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelNormalizedRGFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelNormalizedRGBFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelNormalizedRGBAFormat( const ComponentType& componentType );


    // Non-normalized buffer pixel formats:

    static tex::BufferPixelFormat
    getBufferPixelRedFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelRGFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelRGBFormat( const ComponentType& componentType );

    static tex::BufferPixelFormat
    getBufferPixelRGBAFormat( const ComponentType& componentType );


    // Buffer pixel data type:

    static tex::BufferPixelDataType
    getBufferPixelDataType( const ComponentType& componentType );
